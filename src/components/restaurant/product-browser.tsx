...
export function ProductBrowser({
  ...
  // Derive display names for active filters
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex gap-2 flex-wrap items-center">
        <span className="text-xs font-medium text-muted-foreground mr-1">Supplier:</span>
        <button
      ...
      <div className="flex items-center justify-between">
        <p className="text-sm text-muted-foreground">
          ...
          {activeSupplierName && (
            <span>
              {" "}from <span className="font-medium text-foreground">{activeSupplierName}</span>
            </span>
          )}
        </p>
        {hasFilters && (
                      ...
                      <div className="flex items-end justify-between pt-1">
                        <div>
                          ...
                          <p className="text-[10px] text-muted-foreground mt-0.5">
                            Min: {product.min_order_qty ?? 1} {product.unit}
                          </p>
                        </div>
                        <Button
                          size="sm"
              ...
              <div className="p-3 border-t space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold tabular-nums">
                    EUR {items.reduce((s, i) => s + i.unitPrice * i.quantity, 0).toFixed(2)}
                  </span>
                </div>
